...
import { AuthResponse, AuthLoginRequest, AuthLogoutRequest, AuthRefreshTokenRequest } from "../models/auth.model";
...
export class AuthService{
    ...
    refreshToken(refreshToken:string):Observable<AuthResponse>{
        const request:AuthRefreshTokenRequest = {refreshToken};
    ...
    logout():void{
        ...
        if(refreshToken){
            const request:AuthLogoutRequest = {refreshToken};
