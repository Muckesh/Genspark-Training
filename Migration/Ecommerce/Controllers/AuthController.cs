...
namespace RealEstateApi.Controllers
{
    ...
    public class AuthController : ControllerBase
    {
        ...
        [HttpPost("login")]
        public async Task<ActionResult<AuthResponseDto>> Login([FromBody] AuthLoginRequestDto loginDto)
        {
            try
            {
        ...
        [Authorize]
        [HttpPost("refresh")]
        public async Task<ActionResult<AuthResponseDto>> RefreshToken(AuthRefreshTokenRequestDto refreshTokenRequestDto)
        {
            try
            {
        ...
        [Authorize]
        [HttpPost("logout")]
        public async Task<IActionResult> Logout(AuthLogoutRequestDto logoutRequestDto)
        {
            try
            {
